...
/**
 * Nessuna carta salvata lato backend: i pagamenti passano dal foglio Stripe
 * (PaymentIntent) al momento del deposito, non c'è un modello "metodo salvato".
 * Stato vuoto onesto invece di simulare dati che non esistono.
 */
